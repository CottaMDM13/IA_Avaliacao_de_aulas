...
def evaluate_audio_quality(features, config):
    try:
        ...
        volume_score = 0.95 if 0.03 <= rms <= 0.07 else 0.6
        ...
        try:
            ...
            if not isinstance(gemini_comments, list) or len(gemini_comments) != 5:
                ...
                gemini_comments = [
                    ...
                    {"comment": f"Volume RMS {rms:.4f} {'é adequado' if 0.03 < rms < 0.07 else 'está fora do ideal'}.", "suggestion": "Ajuste o volume para clareza."},
